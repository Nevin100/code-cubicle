...
export default function HomePage() {
  ...
  return (
    <main
      id="hero"
      className={` min-h-screen px-10 md:px-32 py-32 grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-8 items-center transition-colors duration-300 ${textColor}`}
    >
      {/* LEFT SIDE */}
      <div ref={leftRef} className="flex flex-col justify-center md:pl-40">
        <motion.h1
        ...
        <p
          className={`mt-8 text-[22px] md:text-lg leading-relaxed max-w-2xl ${subTextColor}`}
        >
        ...
        {/* Stats Section */}
        <div className="mt-12 flex flex-wrap gap-12 items-start">
          <motion.div whileHover={{ scale: 1.08 }} className="flex flex-col">
            <span className={`text-4xl font-bold ${statTextColor}`}>800+</span>
        ...
        <div className="mt-12">
          <a
            ...
            className="inline-block bg-gradient-to-r from-purple-600 via-pink-700 to-purple-800 text-white font-bold py-4 px-8 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 text-lg md:text-2xl "
          >
            Register Now
          </a>
        </div>
