...
const Navbar: React.FC<PillNavProps> = ({
  ...
  return (
    <div className="fixed top-[1.5em] z-[1000] w-full justify-self-center left-0 md:w-auto md:left-auto">
      {/* Mobile: Hamburger and ModeToggle row */}
      <div className="flex items-center justify-between md:hidden px-4 w-full">
        <button
          ref={hamburgerRef}
                ...
                <>
                  ...
                  {isActive && (
                    <span
                      ...
                      style={{ background: "var(--base, var(--card))" }}
                      aria-hidden="true"
                    />
                  )}
                </>
      ...
      >
        <ul className="list-none m-0 p-[3px] flex flex-col gap-[3px] items-end">
          {items.map((item) => {
